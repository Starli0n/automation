...
--tag-specifications \
	'ResourceType=instance,Tags=[{Key=app_name,Value=kubernetes},{Key=cluster_name,Value='${cluster_name}'},{Key=server_role,Value=master},{Key=Name,Value='${cluster_name}'_mst'${i}'},{Key=project_name,Value=devops}]'
