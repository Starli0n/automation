...
--tag-specifications \
	'ResourceType=instance,Tags=[{Key=app_name,Value=openshift},{Key=cluster_name,Value='${cluster_name}'},{Key=server_role,Value=node},{Key=Name,Value='${cluster_name}'_node'${i}'},{Key=project_name,Value=devops}]'
